...
| ~ | OQ-029 | P1 | Qualcomm quantization/perf experiment: latency, memory, accuracy per deployment variant | OQ-028 — **host baseline measured** (`evidence/benchmark_results/yolo_host_baseline_2026-09-10/`: ONNX Runtime CPU + torch CUDA, shared protocol script `integrations/qualcomm/scripts/profile_yolo_host.py`); X Elite variants remain, blocked on OQ-028 — **2-bit CPU eval landed 2026-09-10** (`integrations/qualcomm/lowbit/` vendored MXFP2/NVINT2 codec + MXFP4 arm, `tests/test_lowbit.py` 43 tests, `scripts/eval_yolo_2bit_cpu.py` 3-tier fp32/mxfp4/nvint2/mxfp2 YOLOv8n arms; evidence `benchmark_results/yolo_2bit_cpu_20260910/`; software-dequantize only) |
