...
| LeRobot — data format / training | [huggingface/lerobot](https://github.com/huggingface/lerobot) | partial — `lerobot` is in the `intel` extra and [`integrations/intel/demonstrations.py`](../../integrations/intel/demonstrations.py) records governed command-level episodes with optional MuJoCo telemetry; motor-level LeRobot conversion and training remain open in [`integrations/intel/README.md`](../../integrations/intel/README.md) |
